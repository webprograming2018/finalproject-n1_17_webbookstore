...
CREATE TABLE `invoice_books` (
  ...
  `INVOICE_BOOK_ID` int(11) DEFAULT NULL,
  `NUMBER` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`),
  KEY `INVOICE_ID_idx` (`INVOICE_ID`),
  KEY `INVOICE_BOOK_ID_idx` (`INVOICE_BOOK_ID`),
  CONSTRAINT `INVOICE_BOOK_ID` FOREIGN KEY (`INVOICE_BOOK_ID`) REFERENCES `book` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-12-30 15:43:52
